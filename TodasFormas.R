...
TodasFormas5 <- function(materia){
  ...
  BaseCC <- rbind(ICC.fit1.DF,ICC.fit2.DF,ICC.fit3.DF,
        ICC.fit4.DF,ICC.fit5.DF,ICC.fit6.DF,ICC.fit7.DF,
        ICC.fit8.DF,ICC.fit9.DF,ICC.fit10.DF,ICC.fit11.DF,
        ICC.fit12.DF)
  colnames(BaseCC) <- c('Habilidad','Pregunta','Probabilidad de acertar','Forma')
  BaseCC
}

Lengua2 <- TodasFormas5('Lengua y Literatura')
CN2 <- TodasFormas5('Ciencias Naturales')
CS2 <- TodasFormas5('Ciencias Sociales')
Mate2 <- TodasFormas5('Matemática')
...
Lengua3 <- TodasFormas6('Lengua y Literatura')
CN3 <- TodasFormas6('Ciencias Naturales')
CS3 <- TodasFormas6('Ciencias Sociales')
Mate3 <- TodasFormas6('Matemática')
